    ...
    <div>
      ...
      >
        ...
        <div className="list text-center mx-10">
          <div className="sizes">
            <h1 className="font-bold text-lg underline">Sizes</h1>
            <ul>
              <li>6” cake- $25</li>
          ...
          <div>
            <div className="frosting">
              <h1 className="font-bold text-lg underline">Frosting</h1>
              <ul>
                <li>cream cheese</li>
                <li>buttercream</li>
              </ul>
            ...
            <div className="fillings">
              <h1 className="font-bold text-lg underline">Fillings</h1>
              <ul>
                <li>buttercream</li>
                <li>cream cheese</li>
                <li>mousse</li>
          ...
          <div>
            <div className="flavors">
              <h1 className="font-bold text-lg underline">Flavors</h1>
              <ul>
                <li>
